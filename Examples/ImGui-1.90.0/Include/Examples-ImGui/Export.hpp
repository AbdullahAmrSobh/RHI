...
#ifndef Examples_ImGui_EXPORT_H
#define Examples_ImGui_EXPORT_H

#ifdef IMGUI_STATIC_DEFINE
#  define Examples_ImGui_EXPORT
#  define IMGUI_NO_EXPORT
#else
#  ifndef Examples_ImGui_EXPORT
#    ifdef ImGui_EXPORTS
...
#  define IMGUI_DEPRECATED_EXPORT Examples_ImGui_EXPORT IMGUI_DEPRECATED
#endif
