function(compile_slang_shaders)
    ...
    foreach(SLANG_SHADER_ABS_PATH ${SLANG_SHADER_SHADER_GFX_FILES})
        ...
        add_custom_command(
            ...
            COMMAND ${SLANGC} -g3 ${SLANG_SHADER_GFX_PATH} ${SLANG_SHADER_ABS_PATH} ${SLANG_SHADER_INCLUDE_DIRS} -o ${SLANG_SHADER_OUTPUT_VERTEX_PATH} -matrix-layout-column-major -entry  VSMain -stage vertex -target spirv -emit-spirv-directly -fvk-use-entrypoint-name
        ...
        add_custom_command(
            ...
            COMMAND ${SLANGC} -g3 ${SLANG_SHADER_GFX_PATH} ${SLANG_SHADER_ABS_PATH} ${SLANG_SHADER_INCLUDE_DIRS} -o ${SLANG_SHADER_OUTPUT_PIXEL_PATH} -matrix-layout-column-major -entry  PSMain -stage fragment -target spirv -emit-spirv-directly -fvk-use-entrypoint-name
            DEPENDS ${SLANGC} ${SLANG_SHADER_ABS_PATH} ${SLANG_SHADER_DEPENDENCIES}
