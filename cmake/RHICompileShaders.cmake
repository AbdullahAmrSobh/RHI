...
function(RHICompileShaders)
	...
	foreach(RHI_SHADER_ABS_PATH ${RHI_ARG_SHADER_FILES})
		...
		add_custom_command(
			...
			COMMAND dxc -spirv ${RHI_SHADER_ABS_PATH} -fspv-reflect -fspv-target-env=vulkan1.3 -E VSMain -T vs_6_7 -Fo ${RHI_OUTPUT_VERT_SPV_SHADER_NAME}
		...
		add_custom_command(
			...
			COMMAND dxc -spirv ${RHI_SHADER_ABS_PATH} -fspv-reflect -fspv-target-env=vulkan1.3 -E PSMain -T ps_6_7 -Fo ${RHI_OUTPUT_PIXEL_SPV_SHADER_NAME}
			DEPENDS ${RHI_SHADER_ABS_PATH} ${RHI_ARG_DEPENDENCIES}
		...
		add_custom_command(
			...
			COMMAND spirv-link -o ${RHI_OUTPUT_SPV_SHADER_MODULE_NAME} --create-library ${RHI_OUTPUT_VERT_SPV_SHADER_NAME} ${RHI_OUTPUT_PIXEL_SPV_SHADER_NAME}
