...
{
    static_assert(std::is_same_v<T, IImage> || std::is_same_v<T, IBuffer>,
...
{
    static_assert(std::is_same_v<T, IImageView>
                      || std::is_same_v<T, IBufferView>,
                  "Invalid Resource Type");
};
...
static_assert(std::is_same_v<ConvertResourceToView<IImage>, IImageView>,
              "Invalid Conversion");
static_assert(std::is_same_v<ConvertResourceToView<IBuffer>, IBufferView>,
              "Invalid Conversion");
static_assert(std::is_same_v<ConvertResourceToDesc<IImage>, ImageDesc>,
              "Invalid Conversion");
static_assert(std::is_same_v<ConvertResourceToDesc<IBuffer>, BufferDesc>,
              "Invalid Conversion");
static_assert(std::is_same_v<ConvertViewToResource<IImageView>, IImage>,
              "Invalid Conversion");
static_assert(std::is_same_v<ConvertViewToResource<IBufferView>, IBuffer>,
              "Invalid Conversion");
static_assert(std::is_same_v<ConvertViewToDesc<IImageView>, ImageViewDesc>,
              "Invalid Conversion");
static_assert(std::is_same_v<ConvertViewToDesc<IBufferView>, BufferViewDesc>,
              "Invalid Conversion");
