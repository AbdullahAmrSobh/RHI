...
namespace RHI::D3D12
{
    ...
    {
        void Init(IDevice* device, const char* debugName, QueueType queueType);
        void Shutdown();
    ...
    struct IDevice : RHI::Device
    {
        ...
        BackendType m_backend = BackendType::DirectX12_2;
        ...
        ID3D12DescriptorHeap* m_resourceHeap = nullptr;
