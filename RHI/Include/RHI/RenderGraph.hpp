...
namespace RHI
{
    ...
    public:
        ...
        void                            PassUseImage(Handle<Pass> pass, Handle<RGImage> attachment, const ImageViewInfo& viewInfo, ImageUsage usage, TL::Flags<PipelineStage> stage, Access access);
        ...
        /// @param stage Shader stage flags.
        /// @param access Access flags.
        void                            PassUseBuffer(Handle<Pass> pass, Handle<RGBuffer> attachment, const BufferViewInfo& viewInfo, BufferUsage usage, TL::Flags<PipelineStage> stage, Access access);
        ...
        TL_NODISCARD Handle<ImageView>  PassGetImageView(Handle<Pass> pass, Handle<RGImage> attachment) const;
        ...
        TL_NODISCARD Handle<BufferView> PassGetBufferView(Handle<Pass> pass, Handle<RGBuffer> attachment) const;
