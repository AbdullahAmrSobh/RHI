...
protected:
    std::unordered_map<std::string, Handle<Attachment>> m_handleNamesMap;

    RHI::HandlePool<Attachment, PassAttachmentList> m_imageAttachments;

    RHI::HandlePool<Attachment, PassAttachmentList> m_bufferAttachments;

    std::vector<Handle<Attachment>> m_transientImageAttachments;
