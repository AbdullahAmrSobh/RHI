...
ImageViewAspectFlags GetImageAspectFlags(Format format)
{
    switch (format)
    {
        ...
        case Format::D24_UNORM_S8_UINT: return ImageViewAspectFlagBits::DepthStencil;
        case Format::D32_FLOAT:
        case Format::D16_UNORM: return ImageViewAspectFlagBits::Depth;
        default: return ImageViewAspectFlagBits::Color;
    }
}
