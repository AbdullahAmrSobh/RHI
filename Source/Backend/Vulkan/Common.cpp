...
EResultCode ConvertResult(VkResult resultCode)
{
    switch (resultCode)
    {
        ...
        case VK_ERROR_OUT_OF_DEVICE_MEMORY:
            return EResultCode::DeviceOutOfMemory;
        case VK_ERROR_EXTENSION_NOT_PRESENT:
            return EResultCode::ExtensionNotAvailable;
        case VK_ERROR_FEATURE_NOT_PRESENT:
            return EResultCode::FeatureNotAvailable;
...
{
    VkShaderStageFlagBits lookup[] = {VK_SHADER_STAGE_VERTEX_BIT,
...
{
    return filter == ESamplerFilter::Linear ? VK_FILTER_LINEAR
                                            : VK_FILTER_NEAREST;
}

VkSamplerMipmapMode ConvertMipMapMode(ESamplerFilter filter)
{
    return filter == ESamplerFilter::Linear ? VK_SAMPLER_MIPMAP_MODE_LINEAR
                                            : VK_SAMPLER_MIPMAP_MODE_NEAREST;
}

VkSamplerAddressMode ConvertAddressMode(ESamplerAddressMode addressMode)
{
    return addressMode == ESamplerAddressMode::Repeat
...
VkCompareOp ConvertCompareOp(ESamplerCompareOp compareOp)
{
    switch (compareOp)
    {
        ...
        case ESamplerCompareOp::GreaterEq:
...
{
    VkSamplerMipmapMode lookup[] = {VK_SAMPLER_MIPMAP_MODE_LINEAR,
                                    VK_SAMPLER_MIPMAP_MODE_NEAREST};
