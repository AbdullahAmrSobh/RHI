...
namespace Vulkan
{
    ...
    public:
        ...
        virtual Expected<ShaderBytecodePtr>    CreateShaderBytecode(const ShaderBytecodeDesc&) override;
        ...
        virtual Expected<CommandQueuePtr>      CreateCommandQueue(CommandQueueTypeFlags) override;
